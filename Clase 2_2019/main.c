...
int main()
{
    ...
    int edad,edadMujerMasVieja,flagVieja=0,flagJoven=0,edadHombreJoven,flagMasAlta=0,edadHombreBajo,flagHombreBajo=0;
    int contadorPersonas=0,acumuladorEdades=0,contadorHombres=0,acumuladorAlturaHombres=0;
    float altura,alturaMujerMasVieja,alturaHombreJoven,AlturaMax,alturaHombreBajo,promedioEdades,promedioAlturaHombres;
    do
    {
        ...
        if(sexo=='f')
        {
            ...
            contadorHombres++;
            acumuladorAlturaHombres=acumuladorAlturaHombres+altura;
    ...
    promedioAlturaHombres=(float)acumuladorAlturaHombres/contadorHombres;
    if(flagVieja==1)
    ...
    printf("\nEl promedio de altura de hombres es:%.2f\n",promedioAlturaHombres);
    system("pause");
    return 0;
}
